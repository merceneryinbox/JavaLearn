...
public class DBServerHandler implements Callable<EntryDic>{
	
	private static EntryDic   entryDic;
	...
	public EntryDic toDoSelector(EntryDic entryDic) throws InterruptedException{
		...
		System.out.println("DBServrHandler : ready to return answer from method toDoSelector in DBServrHandler to call method in"
	...
	public EntryDic deleteEntry(EntryDic entryDic){
		...
		try{
			...
			System.out.println(
				...
				entryDicDelete.flag + " "
				+ entryDicDelete.word + " " + entryDicDelete.definition);
	...
	private EntryDic searchEntry(EntryDic entryDic){
		...
		try{
			...
			System.out.println("DBServerHandler : resultset granted in searchEntry method in DBServerHandler " + tmpDefinitionBack);
